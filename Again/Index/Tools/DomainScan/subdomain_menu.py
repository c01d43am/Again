...
from Tools.DomainScan.dirb_tool import dirbuster_submenu  # Import the run_dirbuster function
...
def subdomain_submenu():
    ...
    while True:
        ...
        if choice == "1":
            dirbuster_submenu()  # Call DirBuster with user input
        elif choice == "2":
            subdomain = input("Enter the subdomain to scan with SSLscan: ")
            check_and_install_sslscan(subdomain)
        elif choice == "3":
