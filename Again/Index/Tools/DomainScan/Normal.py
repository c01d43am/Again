...
def network_scan(local_ip):
    ...
    print(f"\n[INFO] Scanning network: {local_ip} (Full Range)\n")
    print("----------------------------------------------------\n")
...
def main():
    ...
    local_ip = get_local_ip()
    if local_ip:
        network_scan(local_ip)  # Scan the network using ping
        arp_scan()  # Run ARP scan for connected devices
    else:
